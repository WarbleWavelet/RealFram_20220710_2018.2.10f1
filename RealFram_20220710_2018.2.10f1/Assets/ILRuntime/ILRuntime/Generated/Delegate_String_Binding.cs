...
{
    unsafe class Delegate_String_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Delegate_String);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Delegate_String instance_of_this_method;
            instance_of_this_method = (Delegate_String)typeof(Delegate_String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
