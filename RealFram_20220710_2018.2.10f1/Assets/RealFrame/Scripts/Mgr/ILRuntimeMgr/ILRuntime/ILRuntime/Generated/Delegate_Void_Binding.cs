...
{
    unsafe class Delegate_Void_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Delegate_Void);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Delegate_Void instance_of_this_method;
            instance_of_this_method = (Delegate_Void)typeof(Delegate_Void).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
