...
namespace Demo02
{
    ...
    public class Demo02_Class2Xml : MonoBehaviour
    {
        ...
        void Start()
        {
            Transform canvans = GameObject.FindGameObjectWithTag(Tags.Canvas).transform;
            btn1 = canvans.Find("btn1").GetComponent<Button>();
            btn2 = canvans.Find("btn2").GetComponent<Button>();
