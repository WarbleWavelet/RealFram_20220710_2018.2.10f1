...
namespace Demo15
{
    ...
    public class HotfixWnd : Window
    {
        ...
        public override void OnAwake(params object[] paralist)//UIMgr中被调用
        {
            m_SumTime = 0;
        ...
        public override void OnClose()
        {
            HotPatchMgr.Instance.ServerInfoError -= ServerInfoError;
            HotPatchMgr.Instance.ItemError -= ItemError;
            SceneMgr.Instance.LoadScene(DefinePath_Demo15.Prefab_HotfixPanel ,DefinePath_Demo15.Scene_Menu);  //加载场景
        }
